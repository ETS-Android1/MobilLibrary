...
import com.example.efmist.Not.NewNoteActivity;
...
public class CameraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //action bar ismini değiştirir..
        setTitle("Kamera Sayfası");
        ...
        addnotBtn = (Button) findViewById(R.id.addnotBtn);
    ...
    //yazılanları notlara ekleme
    public void notEkleBtn(){
        addnotBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String text = mResultEt.getText().toString();
                Intent intent = new Intent(CameraActivity.this, NewNoteActivity.class);
        ...
        dialog.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (which == 0) {
                    ...
                    //for os marshmallow and above we need to ask runtime permisson for camera and storage
    ...
    private void pickCamera() {
        //intent to take image from camera, it will also save to storage to get hq image
